...
function correctBroadMatchModified() {
  ...
  var SPREADSHEET_URL = 'https://docs.google.com/spreadsheets/d/1Rf0JPVJwgDoy9QAmOOeMbg_cTryDduvCM4sP3XbvSuQ/edit#gid=877998325';
  ...
  //Change the variable below to 'ALL' to run on all Broad Keywords
  var fullBroad = 'PARTIAL';

  //Working Code Below. Don't edit unless you know what you're doing///////////////////////////////////////////////////////////
  //-------------------------------------------------------------------------------------------------------------------------//
...
function writeToSpreadsheet(keywordList,headers,SPREADSHEET_URL2,SHEET_NAME2) {
  var spreadsheet;
  //Open previously created spreadsheet
  spreadsheet = SpreadsheetApp.openByUrl(SPREADSHEET_URL2);
  if(spreadsheet == undefined){
    Logger.log('Invalid Spreadsheet link. Check URL Provided');
    return undefined
  }
  //Select sheet to edit based on name provided
  var sheet = spreadsheet.getSheetByName(SHEET_NAME2);
  if(sheet == undefined){
    Logger.log('Invalid Sheet Name. Check Sheet Name matches in script and spreadsheet');
    return undefined
  }
